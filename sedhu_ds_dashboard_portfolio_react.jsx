        ...
        <section className="py-20">
          ...
          <div className="bg-white/5 border border-white/10 rounded-3xl p-8 backdrop-blur-xl shadow-xl">
            <p className="text-gray-300 text-lg leading-9">
              I have 2 years of experience as a Customer Success Engineer and
              2 years as a Frontend Web Application Developer. Recently, I
              transitioned into Data Science and Machine Learning with a strong
              interest in intelligent systems, recommendation engines, NLP,
              and computer vision.
            </p>
          </div>
        </section>
